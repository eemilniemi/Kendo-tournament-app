...
const TermsAndConditions: React.FC = () => {
  return (
    <div className="Terms">
      ...
      <Typography variant="subtitle1">Last updated March 4, 2024</Typography>
      <Typography variant="h3">AGREEMENT TO OUR LEGAL TERMS</Typography>
      <Typography variant="body1">
        We are Sei Shin Ken Kai ry (&apos;Company&apos;, &apos;we&apos;,
        &apos;us&apos;, or &apos;our&apos;). We operate the website{" "}
        <Link href="app.kendoliiga.fi">app.kendoliiga.fi</Link> (the
      ...
      <Typography variant="body1">
        ...
        promptly update such registration information as necessary; you have the
        legal capacity and you agree to comply with these Legal Terms; you are
        not a minor in the jurisdiction in which you reside; you will not access
        the Services through automated or non-human means, whether through a
        bot, script or otherwise; you will not use the Services for any illegal
        or unauthorised purpose; and your use of the Services will not violate
      ...
      <Typography variant="body1">
        ...
        <br></br>
        <br></br>
        It is prohibited to post, send, publish, upload, or transmit through the
      ...
      <Typography variant="body1">
        ...
        differ from applicable laws in Finland, then through your continued use
        of the Services, you are transferring your data to Finland and you
