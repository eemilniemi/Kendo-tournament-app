...
const DeleteUserFromTournament: React.FC = () => {
 ...
 /* const apiDeleteUserRequest = async (tournamentId, userId): Promise<void> => {
    handleCloseConfirmDialog();
    try {
      await api.tournaments.marchUserMatchesLost(tournamentId, userId);
    } catch (error) {
      ...
      >
        ...
        <DialogActions>
          ...
          <Button
            ...
            variant="contained"
            onClick={ /*() => { ()
               apiDeleteUserRequest(tournament.id, selectedUserId)
            }*/ }
            autoFocus
          >
